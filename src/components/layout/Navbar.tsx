...
import { Book, LayoutDashboard, Library, LogOut, Menu, Moon, Plus, Search, Sun, User as UserIcon, X } from 'lucide-react';
...
export function Navbar() {
  ...
  const navLinks = [
    ...
    ...(role === 'author' ? [
      { name: 'Upload', path: '/upload', icon: <Plus className="w-4 h-4 mr-2" /> },
